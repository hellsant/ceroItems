    ...
    public partial class Stock : Form
    {
        ...
        private bool Validation()
        {
            ...
            if (string.IsNullOrEmpty(textBox1.Text))
            {
                ...
                errorProvider1.SetError(textBox1, "Codigo de producto requerido");
            }
            ...
            {
                errorProvider1.Clear();
                errorProvider1.SetError(textBox3, "Cantidad requerida");
            }
        ...
        {
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("Select 1 From [Stock] WHERE [ProductCode]='" + productCode + "'", con);
        ...
        {
            SqlConnection connection = Connection.GetConnection();
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("Select * From [Stock].[dbo].[Stock]", connection);
            DataTable data = new DataTable();
            sqlDataAdapter.Fill(data);
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Seguro que desea eliminar", "Message", MessageBoxButtons.YesNo);
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            if (textBox1.Text.Length > 0)
            {
                ...
                dgview.BringToFront();
                Search(150, 105, 430, 200, "Codigo, Nombre", "100,0");
                this.dgview.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.proCode_MouseDoubleClick);
                SqlConnection con = Connection.GetConnection();
                SqlDataAdapter sda = new SqlDataAdapter("Select Top(5) ProductCode,ProductName From [Products] WHERE [ProductCode] Like '" + textBox1.Text + "%'", con);
                DataTable data = new DataTable();
                sda.Fill(data);
                dgview.Rows.Clear();
